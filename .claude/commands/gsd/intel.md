...
Intel system is disabled. To activate:
  ...
  node /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs
