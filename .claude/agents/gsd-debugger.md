...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/mateuspires/Dev/agent-clinic/.claude
                  → checks /Users/mateuspires/Dev/agent-clinic/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done
                  → writes to /Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/hooks/
...
@/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
