...
Reference full template: `/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/templates/state.md`.
