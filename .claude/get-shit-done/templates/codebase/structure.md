...
- Usage: Reference from command with `@/Users/mateuspires/Dev/agent-clinic/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/mateuspires/Dev/agent-clinic/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/mateuspires/Dev/agent-clinic/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
